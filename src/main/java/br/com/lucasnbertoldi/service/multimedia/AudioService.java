 ...
 */
package br.com.lucasnbertoldi.service.multimedia;
...
public class AudioService {
    ...
    public static Float getOutputVolume(Line line) {
    ...
    public static Line getMasterOutputLine() {
        for (Mixer mixer : getMixers()) {
            for (Line line : getAvailableOutputLines(mixer)) {
                if (line.getLineInfo().toString().contains("SPEAKER target port")) {
                    return line;
                }
            }
        }
